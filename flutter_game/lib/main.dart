...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static const String _bgMusicAsset = 'assets/audio/game_music.mp3';
  ...
  Future<void> _startBgMusic() async {
    try {
      await _audioPlayer.play(AssetSource(_bgMusicAsset));
    } catch (_) {
      // If the audio asset can't be loaded (e.g. missing/incorrect path),
      // keep the game playable instead of crashing on startup.
    }
  }
